...
// is it a goed idee to use much script, where to store it local (how to upgrade over air) or remote=computer blue? https://www.youtube.com/watch?v=szs4bWoul8w 
//
//
